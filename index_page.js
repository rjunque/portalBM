...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Lógica para carregar e exibir as notícias na página inicial
    fetch('noticias_db.html')
        ...
        .then(data => {
            ...
            allNews.forEach(newsItem => {
                ...
                // Remover os links de navegação específicos do DB
                const dbNavLinks = clonedNewsItem.querySelector('.nav-links');
                if (dbNavLinks) {
                    dbNavLinks.remove();
                }

                // Injetar o link "Ver notícia completa" fora do details
                ...
                if (detailsElement) {
                    ...
                    // Remova sourceLink.target = '_blank'; para que o histórico funcione corretamente
