...
.banner-section {
    text-align: center;
    padding: 20px;
    background-color: #fff; /* Fundo branco para o banner */
...
.news-item-expandable {
    background-color: #f9f9f9; /* Fundo cinza claro para cada notícia */
...
.news-item-expandable summary {
    cursor: pointer;
    padding: 15px;
    background-color: #eee; /* Fundo cinza para o cabeçalho expansível */
    font-weight: bold;
    border-bottom: 1px solid #ddd;
...
.news-item-expandable h3 {
    margin: 0 0 5px 0;
    color: #0056b3; /* Cor azul para o título da notícia */
    font-size: 1.3rem;
...
.news-item-expandable .news-full-link-container {
    ...
    background-color: #f0f0f0; /* Fundo para o container do link */
...
.news-item-expandable .news-full-link-container a {
    color: #007bff; /* Cor azul para o link "Ver notícia completa" */
    text-decoration: none;
    font-weight: bold;
...
.news-db-item .nav-links .db-back-home-button {
    background-color: #007bff; /* Cor azul para os botões de navegação */
    color: white;
    padding: 10px 15px;
    border: none;
    border-radius: 5px;
